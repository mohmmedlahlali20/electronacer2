...
<body class="bg-gray-100 p-8 bg-gray-100">
  ...
  <div class="container mx-auto dii">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 ">
      <div>
          <label style="font-family:bold italic; color:black" for="categorias"> filtre par prix</label>
            <form method="post" action="">
              <select name="categorias">
                  <option value="op-0">all price</option>
                  <option value="op-1">100-200$</option>
                  <option value="op-2">300-400$</option>
                  <option value="op-3">plus que 400$</option>
              </select>
      ...
      <div >
      <form  class="mt-5  grid-cols-6 md:grid-cols-2 gap-5 grid" method="get" action="">
    <!-- <label style="font-family:bold italic; color:black ; margin-left:20px"  for="sort">Sort by:</label> -->
    <select style="width: 200px;" class=" " name="sort" id="sort">
        <option value="asc">Price Ascending</option>
        <option value="desc">Price Descending</option>
    </select>
    <button style="" class="bg-blue-500 hover:bg-blue-700  text-white font-bold py-2 px-4 rounded" type="submit">Sort</button>
</form>
      </div>
